    ...
    <section class="mx-auto max-w-6xl px-6 py-14">
        ...
        <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            @forelse ($artists as $artist)
                <article class="overflow-hidden rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-[0_18px_50px_rgba(121,91,255,0.08)]">
                    <a href="{{ route('public.artist', $artist) }}" class="text-lg font-semibold text-[#2b183d] transition hover:text-[#ef476f]">
